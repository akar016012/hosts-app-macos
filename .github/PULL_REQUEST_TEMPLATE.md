...
- [ ] The app builds: `cd native && ./build.sh`.
- [ ] Tests pass: `bash native/test.sh` — and I added/updated tests for any new logic.
...
- [ ] I did **not** commit secrets, personal signing identities, or generated build artifacts (`native/HostsEditor.app`, `native/.signid`).
