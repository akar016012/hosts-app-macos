...
- **PIN and macOS-password unlock now work on Macs without Touch ID.** On a
  ...
  every path that reaches it has already authenticated the user through
  whichever unlock method they chose.

### Contributors

Thanks to everyone who contributed to this release:

- Aditya Kar ([@akar016012](https://github.com/akar016012)) — #43, #44
- [@dominikfiala](https://github.com/dominikfiala) — reported #41
...
[Unreleased]: https://github.com/akar016012/hosts-app-macos/compare/v1.3.2...HEAD
[1.3.2]: https://github.com/akar016012/hosts-app-macos/compare/v1.3.1...v1.3.2
